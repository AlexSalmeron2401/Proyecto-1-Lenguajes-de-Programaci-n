...
from frontend.vista_editarDatosEstudiante import VentanaEditarDatosEstudiante
from frontend.vista_verCursosEstudiante import VentanaCursos
...
class VentanaPrincipalVisor(QWidget):
    ...
    def init_ui(self):
        ...
        btn_editar = QPushButton("Editar Mis Cursos")
