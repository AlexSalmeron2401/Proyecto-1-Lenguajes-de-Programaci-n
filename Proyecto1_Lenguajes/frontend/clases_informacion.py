...
# Clase Profesor: tiene nombre, ID y una lista de años en los cuales impartió cursos
@dataclass
class Profesor:
    nombre: str
    id: str
...
# Para modelar la información de un curso que llevó un estudiante, se puede usar una clase auxiliar
@dataclass
class CursoCursado:
    curso: Curso
    ano: int
...
# Clase Estudiante: contiene datos básicos y la lista de cursos cursados
@dataclass
class Estudiante:
    nombre: str
    id: str
